...
The workshop is open and free to all researchers in the Netherlands. The workshop is based on the teaching style of the Carpentries, and learners will follow along while the instructors write the code on screen. More information can be found on the `r params$workshop_website`.  
...
The Netherlands eScience Center is organising an online workshop in `r params$month`. The topic is “`r params$workshop`”. The workshop is open and free to all researchers in the Netherlands. 
...
You can also follow us on [Twitter](https://twitter.com/esciencecenter) [2]. We are continuously organising training events. You can find the list of upcoming events on the Center’s [website](https://www.esciencecenter.nl/digital-skills/) [3].  
  
We would also like to encourage you to subscribe to our [email updates](https://esciencecenter.us8.list-manage.com/subscribe/post?u=a0a563ca342f1949246a9f92f&id=31bfc2303d) [4] and select an Invitation for Workshops option to get invited to training and related events organised by the Netherlands eScience Center.
...
[3] https://www.esciencecenter.nl/digital-skills/ 
