...
`r params$date`, `r params$location`  
...
**Who**: [target audience], [prerequisites].  
  
Emails short description:  
[two sentences] for in the advertisement emails
...
The Netherlands eScience Center is organizing an online workshop in `r params$month`. The topic is “`r params$workshop`”. The workshop is open and free to all researchers in the Netherlands. 

The registration is now open to our partners and collaborators. They can use the code "eScience2021" to unlock the “eScience Center Partners” ticket when registering. 
...
Make sure you have the necessary software installed on your laptop by following the [setup instructions] ([`r paste0(params$workshop_website_url, '/#setup')`]) [2]. If you have any trouble, send us an email.
...
Let us know if you have any questions, otherwise, we will see you on `r params$day_of_workshop` from `r params$start_time`! 
...
If you won’t be able to attend, please cancel your registration (by following instructions here [1])  so that we can offer your seat to someone on the waiting list.
...
You will shortly be able to find all the notebooks and collaborative documents from the workshop in the files directory of the workshop repository.  
  
If you have any other feedback about the workshop, or would like to get involved in organizing workshops, please contact the eScience Center training team at training@esciencecenter.nl [2].  
  
You can also follow us on Twitter (https://twitter.com/esciencecenter). We are continuously organizing training events. You can find the list of upcoming events on the Center’s training website[https://escience-digital-skills.github.io] [3].  
  
We would also like to encourage you to subscribe to our email updates [4] and select an Invitation for Workshops option to get invited to training and related events organized by the Netherlands eScience Center.

On behalf of the workshop organization team,

Mateusz Kuzak & Lieke de Boer  
  
Links  
[1] [post-workshop survey link]  
[2] https://twitter.com/esciencecenter  
[3] https://escience-digital-skills.github.io/  
[4] https://esciencecenter.us8.list-manage.com/subscribe/post?u=a0a563ca342f1949246a9f92f&id=31bfc2303d  
